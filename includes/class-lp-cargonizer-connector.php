...
class LP_Cargonizer_Connector {
	...
	public function register_hooks() {
		...
		add_action('wp_ajax_lp_cargonizer_save_settings', array($this, 'ajax_save_settings'));
		add_action('wp_ajax_lp_cargonizer_direct_print_upload', array($this, 'ajax_direct_print_upload'));
